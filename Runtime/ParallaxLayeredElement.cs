...
namespace SoftBoiledGames.Parallaxer
{
    public abstract class ParallaxLayeredElement : ParallaxElement
    {
        ...
        [SerializeField] 
        [InspectorAttributes.ShowIf(nameof(_debugMode), true)] 
        [InspectorAttributes.LeftToggle] 
        ...
        {
            return MathLibrary.Abs(1f / base.Transform.position.z);
        }
        ...
        private float GetForegroundSpeed()
        {
            ...
            return MathLibrary.Abs((base.Transform.position.z) / lowestZavailable);
        }
